...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<div id="minimapbg" style="position: absolute; right: 1em; top: 2em;">' +
        ...
        '<span id="hide-map" style="cursor:pointer;font-weight:bold;color: rgb(255, 255, 0);"> Hide' +
